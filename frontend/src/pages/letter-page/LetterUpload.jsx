...
import { addLetterValidation } from "../../middlewares/formValidations";
...
const LetterUpload = () => {
  ...
  const addLetterCallback = useCallback(
    (actions) => (response) => {
  ...
  const handleSubmit = (values, actions) => {
    openConfirmAlert({
      confirmTitle: "Tambah Arsip Surat",
      confirmText: "Apakah anda yakin ingin menambah data arsip surat?",
      okAction: () => {
        fetch({
          url: "/surat",
          method: "POST",
          data: values,
          cb: addLetterCallback(actions),
        });
  ...
  return (
    <div className="pr-4">
      ...
      <div className="bg-white p-4 rounded-md shadow-md">
        ...
        <Formik initialValues={initialValues} validate={addLetterValidation} onSubmit={handleSubmit}>
